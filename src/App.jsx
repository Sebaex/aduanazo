  ...
  return (
    ...
    <div className="text-white">
      <div>
        ...
        <br/>
        <section className="">
          <p className="text-2xl">Ingresa el valor de la compra en dolares</p>
      ...
      <button className="bg-blue-700 text-white rounded-md p-2 px-6 my-10" onClick={() => dialogRef.current.showModal()}>¿Y como funciona?</button>

      <div>
        <p>Valor del dolar: ${valorDolar}</p>
